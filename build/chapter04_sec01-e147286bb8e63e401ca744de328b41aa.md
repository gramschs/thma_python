...
```{code-cell} python
print('Hallo' == 'Welt')   # Ausgabe: False
print('Hallo' == 'Hallo')  # Ausgabe: True
print('Hallo' == 'hallo')  # Ausgabe: False
```
...
Überprüfung von Teil-Strings kennengelernt. Im nächsten Kapitel werden wir
