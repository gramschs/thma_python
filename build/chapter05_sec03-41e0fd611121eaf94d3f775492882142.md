...
gezählten Häufigkeiten als Listen an `px.bar()` übergeben. Das Muster aus
Kapitel 5.2 (Listen befüllen, dann visualisieren) wird hier mit dem
Zählermuster aus Übung 5.4 kombiniert.
````
