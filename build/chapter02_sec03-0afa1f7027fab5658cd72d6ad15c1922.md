...
Tipp 1: Vergessen Sie nicht die Leerzeichen und Kommas zwischen den Textteilen!
Tipp 2: Die geschweiften Klammern `{` und `}`brauchen Sie nicht ausgeben. Sie
stehen hier als Platzhalter.
````
