...
```
Die Ausgabe enthält viele Nachkommastellen, da Python mit Gleitkommazahlen rechnet. Wir könnten die Ausgabe mit f-strings formatieren:
```python
    print(f"v = {v} km/h,  Anhalteweg = {anhalteweg:.1f} m")
```
