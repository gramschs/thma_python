...
Achsenbeschriftung lassen. Voreingestellt ist deutsch (=DE). Aber wenn Englisch
(=EN) gewählt wird, soll der Titel "Brake disc temperature during braking"
lauten und die Achsenbeschriftung "Time in seconds" bzw. "Temperature in °C".
