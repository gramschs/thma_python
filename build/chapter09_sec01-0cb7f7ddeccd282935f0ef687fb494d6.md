...
# 9.1 Funktionen selbst schreiben
...
for v in range(30, 131, 10):
    ...
    print(f'v = {v:3d} km/h,  Bremsweg = {s:6.1f} m')
```
...
for v in [50, 80, 100]:
    ...
    print(f'v = {v:3d} km/h,  Anhalteweg = {s:6.1f} m')
```

Ausgabe:
```
v =  50 km/h,  Anhalteweg =  38.9 m
v =  80 km/h,  Anhalteweg = 108.2 m
...
Eine Python-Funktion kann mit `return` auch mehrere Werte gleichzeitig
zurückgeben, indem diese durch Kommas getrennt werden:
...
for U, I in messwerte:
    ...
    print(f'U = {U:3d} V,  I = {I:2d} A,  P = {P:6.0f} W')
```
