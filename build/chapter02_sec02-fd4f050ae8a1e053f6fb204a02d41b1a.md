...
(dazu muss die Markdown-Zelle noch in eine Code-Zelle umgewandelt werden):
...
Und soll es eine Fließkommazahl werden, können wir folgendermaßen vorgehen:
