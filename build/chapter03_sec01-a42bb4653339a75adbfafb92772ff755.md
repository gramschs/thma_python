...
die `.remove()`-Methode erneut anwenden. Darauf verzichten wir hier. Stattdessen
erweitern wir jetzt die Liste um einen neuen Schraubenschlüssel "M48". Dazu
verwenden wir die `.append()`-Methode, die ebenfalls mit einem Punkt getrennt an
