...
* Die **Box** reicht vom 25%-Quartil (Q1) bis zum 75%-Quartil (Q3) und
  enthält die mittleren 50 % aller Werte. Die Breite der Box heißt
...
* Die **Whisker** (Antennen) erstrecken sich bis zum kleinsten bzw. größten
  Wert innerhalb des 1.5-fachen IQR.
