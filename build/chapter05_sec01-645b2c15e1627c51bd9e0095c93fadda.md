...
Schleifendurchgang den Wert `"Anna"` an. Dann werden die Anweisungen im
Schleifeninneren ausgeführt, also die `print()`-Funktion für `zettel = "Anna"` angewendet
und ausgegeben. Dann wird die Schleife ein 2. Mal durchlaufen. Diesmal
