...
```
Rufen Sie die eingebaute Hilfe für die Funktion `len` auf und vergleichen Sie
die Ausgabe mit der Hilfe von `px.scatter`. Gibt es Gemeinsamkeiten in der
...
Bei den Hilfebeschreibungen wird zuerst der Funktionsaufruf mit Argumenten gezeigt, dann folgt eine kurze Beschreibung, was der Zweck der Funktion ist. Als nächstes werden detailliert die Parameter der Funktion beschrieben und zuletzt wird der Rückgabewert der Funktion angezeigt. Damit folgt die Hilfe dem EVA-Prinzip. Welche Eingaben sind möglich (Argumente und Parameter der Funktion) und was gibt de Funktion nach der Verarbeitung als Ausgabe zurück. 
