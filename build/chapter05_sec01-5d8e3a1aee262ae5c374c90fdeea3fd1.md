...
```{code-cell} ipython3
for zettel in ["Anna", "Anna", "Anna", "Bob", "Anna", "Bob", "Bob"]:
    print(zettel)
```

Nacheinander wird die Variable `zettel` auf die Werte in der Liste `["Anna",
"Anna", "Anna", "Bob", "Anna", "Bob", "Bob"]` gesetzt und per `print()`
