...
:class: tip
Erzeugen Sie eine Liste für ein Werkzeug Ihrer Wahl mit der Bezeichnung des
Werkzeugs, dem Hersteller und dem Preis. Welche Datentypen brauchen Sie für
diese drei Eigenschaften des Werkzeugs? Lassen Sie Ihre Liste auch ausgeben.
```
...
:class: dropdown
```python
werkzeug = ['Bohrmaschine', 'Bosch', 199.95]
print(werkzeug)
```
