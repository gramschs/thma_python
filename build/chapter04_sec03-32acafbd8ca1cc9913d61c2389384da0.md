...
kurs_unter_einstieg = False

if kurse_euro[0] < EINSTIEGSPREIS_EURO:
    print('Tag 1: Kurs unter Einstiegspreis! Kurs:', kurse_euro[0], 'Euro')
    kurs_unter_einstieg = True
if kurse_euro[1] < EINSTIEGSPREIS_EURO:
    print('Tag 2: Kurs unter Einstiegspreis! Kurs:', kurse_euro[1], 'Euro')
    kurs_unter_einstieg = True
if kurse_euro[2] < EINSTIEGSPREIS_EURO:
    print('Tag 3: Kurs unter Einstiegspreis! Kurs:', kurse_euro[2], 'Euro')
    kurs_unter_einstieg = True
if kurse_euro[3] < EINSTIEGSPREIS_EURO:
    print('Tag 4: Kurs unter Einstiegspreis! Kurs:', kurse_euro[3], 'Euro')
    kurs_unter_einstieg = True
if kurse_euro[4] < EINSTIEGSPREIS_EURO:
    print('Tag 5: Kurs unter Einstiegspreis! Kurs:', kurse_euro[4], 'Euro')
    kurs_unter_einstieg = True
if kurse_euro[5] < EINSTIEGSPREIS_EURO:
    print('Tag 6: Kurs unter Einstiegspreis! Kurs:', kurse_euro[5], 'Euro')
    kurs_unter_einstieg = True
if kurse_euro[6] < EINSTIEGSPREIS_EURO:
    print('Tag 7: Kurs unter Einstiegspreis! Kurs:', kurse_euro[6], 'Euro')
    kurs_unter_einstieg = True

# Verarbeitung: Gewinnanalyse
differenz_euro = kurse_euro[6] - EINSTIEGSPREIS_EURO

if differenz_euro > 0:
    print('Aktueller Gewinn:', differenz_euro, 'Euro')
if differenz_euro < 0:
    print('Aktueller Verlust:', differenz_euro, 'Euro')
...
if kurs_unter_einstieg == True:
    fig.add_annotation(text='Achtung: Kurs unter Einstiegspreis!')
...
mit denen sich diese Analyse elegant in wenigen Zeilen formulieren lässt.
````
