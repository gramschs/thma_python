...
Liste war, macht der Python-Interpreter mit dem normalen Programm weiter. Bei
unserem kurzen Beispiel ist aber schon das Ende des Programmes erreicht.
Zusammengefasst, werden nacheinander die Elemente der Liste `"Bob", "Anna",
"Anna", "Bob", "Anna", "Bob", "Anna"` auf dem Bildschirm ausgegeben.
...
`0`. Miot einer for-Schleife gehen wir jeden Zettel durch. Steht auf dem Zettel
