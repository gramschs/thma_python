...
```{admonition} Mini-Übung
:class: tip
Lassen Sie nun Python einen Schraubenschlüssel der Größe 12 mm an den leeren
Platz legen, d.h. speichern Sie den String `'12 mm'` an Position 3. Lassen Sie
den Werkzeugkoffer zur Kontrolle anzeigen.
```
