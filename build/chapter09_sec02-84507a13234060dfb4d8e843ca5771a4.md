...
beliebig oft aufgerufen werden – in Schleifen, für verschiedene Parameterwerte
und zur Visualisierung von Kennlinien. Das ist deutlich übersichtlicher als
dieselbe Berechnung an mehreren Stellen im Code zu wiederholen.
...
muss dabei in Radiant angegeben werden. Python stellt `math.radians()` bereit,
...
def berechne_wurfweite(v0_ms, alpha_grad):
    ...
    return v0_ms**2 * math.sin(2 * alpha_rad) / g
```
