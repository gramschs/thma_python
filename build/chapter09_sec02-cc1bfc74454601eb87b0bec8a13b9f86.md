...
und Widerstand $R$: $U = R \cdot I$. Wir implementieren es als Funktion und
visualisieren die Spannungs-Strom-Kennlinie für verschiedene Widerstände.
...
muss dabei in Radiant angegeben werden. NumPy stellt `np.deg2rad()` bereit,
um Grad in Radiant umzurechnen.
