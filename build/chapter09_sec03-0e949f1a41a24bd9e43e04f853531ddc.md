...
5. Visualisieren Sie alle drei Größen jeweils als eigenes Liniendiagramm.
...
# Ausgabe: Diagramme
fig1 = px.line(x=geschwindigkeiten, y=reaktionswege,
               labels={"x": "Geschwindigkeit (km/h)", "y": "Weg (m)"},
               title="Reaktionsweg in Abhängigkeit der Geschwindigkeit")
fig1.show()

fig2 = px.line(x=geschwindigkeiten, y=bremswege,
               labels={"x": "Geschwindigkeit (km/h)", "y": "Weg (m)"},
               title="Bremsweg in Abhängigkeit der Geschwindigkeit")
fig2.show()

fig3 = px.line(x=geschwindigkeiten, y=anhaltewege,
               labels={"x": "Geschwindigkeit (km/h)", "y": "Weg (m)"},
