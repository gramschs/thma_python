...
| Fehler | Zeile | Problem |
| ------ | ----- | ------- |
| 1 | `zoll = input(...)` | Rückgabe von `input()` ist String, muss in Float umgewandelt werden |
| 2 | `print(... + zentimeter + ...)` | `zentimeter` ist Float, muss für String-Verkettung in String umgewandelt werden |
