...
Die einfachste Art, eine List zu manipulieren, ist die **Verkettung** zweier
...
`+`-Operator in eine gemeinsame, neue Liste so als ob wir die Schraubenschlüssel
aus beiden Koffern zusammenlegen würden.

```{code-cell} python
# Erzeugung zweier Listen für zwei Werkzeugkoffer
wergzeugkoffer_gross = ['M5', 'M8', 'M12', 'M20', 'M24', 'M27', 'M30']
